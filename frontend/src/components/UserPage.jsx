    ...
    render(){
        return (
            ...
            (<div className="Full-view">
                    ...
                    <Container>
                        <Row className="Game-div justify-content-center" noGutters>
                            <Col>
                                ...
                                <img className="profile-picture" src="images/userLogo.png"></img>
                            </Col>
                        ...
                        <Row className="Game-div justify-content-center" noGutters>
                            <Col className = "center-items">
                                <a href = "/wishlist">
                                    <button type="button" className="user-page-btn user-page-btn-2 user-page-btn-2g" >Wishlist</button>
                                </a>
                            </Col>
                        
                            <Col className = "center-items justify-content-end">
                            <button type="button" onClick={() => this.setState({getReviews: !this.state.getReviews})} className="user-page-btn user-page-btn-2 user-page-btn-2g" >Reviews</button>
                            </Col>
                        </Row>
                    </Container>
                    {this.state.getReviews ? (this.state.gameReviews && this.state.gameReviews.map((rev, index) => {
             ...
             </div>): (<Link to={{ pathname: '/' }} /*onClick={this.onCardClick}*/><HomePage /></Link>)
        )
    }
}
